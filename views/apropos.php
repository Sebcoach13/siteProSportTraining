<main>
    ...
    <h2>MES SERVICES</h2>
    <ul> <li>
            <h3>Programmes d’entraînement personnalisés</h3> <p>Bénéficiez de plans d’entraînement conçus par un expert, adaptés à votre niveau, vos besoins et vos objectifs spécifiques.</p>
        </li>
        <li>
            <h3>Conseils nutritionnels</h3>
            <p>Apprenez à nourrir votre corps de manière équilibrée avec des plans de repas et des conseils nutritionnels adaptés à votre mode de vie et à vos objectifs.</p>
        </li>
        <li>
            <h3>Suivi et motivation</h3>
            <p>Restez motivé et sur la bonne voie grâce à un suivi régulier et des encouragements de la part de votre coach personnel.</p>
        </li>
    </ul>
